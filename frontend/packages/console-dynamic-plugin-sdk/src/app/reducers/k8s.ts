...
import { getQN, referenceForModel } from '../module/k8s/k8s'; // getQN no info, Done! "getReferenceForModel"
import { allModels } from '../module/k8s/k8s-models';
import { K8sResourceKind, K8sKind } from '../module/k8s/types'; // Comment regarding weakening type checking - use K8sResourceCommon instead
