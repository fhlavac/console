...
import { K8sResourceKindReference, FirehoseResult } from '../../../extensions/console-types';
...
export type PageHeadingProps = {
  ...
  customActionMenu?:
    | React.ReactNode
    | ((kindObj: K8sModel, obj: K8sResourceKind) => React.ReactNode); // Renders a custom action menu.
